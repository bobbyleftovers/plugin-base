...
use Carbon_Fields\Datastore;
use BarrelDirectory\Includes\Db\Db_Control;

/**
 * Theme options datastore class.
 */
class Directory_Datastore extends Datastore\Key_Value_Datastore {
	/**
